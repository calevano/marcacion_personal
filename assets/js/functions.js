...
$(document).ready(function(){
    ...
    (function(){
        //Toggle
        $(document).on('click', '#menu-trigger, #chat-trigger', function(e){
            e.preventDefault();
            var x = $(this).data('trigger');

            $(x).toggleClass('toggled');
            $(this).toggleClass('open');
            $(document).toggleClass('modal-open');
    ...
    */
	...
	//Edit
	$(document).on('click', '.hec-button', function(){
	...
	//Save
	$(document).on('click', '.hec-save', function(){
