    ...
    function renderPagination()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (this.rowCount !== -1 && (headerPagination.length + footerPagination.length) > 0)
            {
                ...
                renderPaginationItem.call(this, pagination, "first", "<i class='zmdi zmdi-more'></i>", "first")
                ...
                renderPaginationItem.call(this, pagination, "last", "<i class='zmdi zmdi-more'><i>", "last")
                    ._bgEnableAria(totalPages > current);
